...
export default function YTPCard({ ytp }: { ytp: VideoObject }) {
  ...
  return (
    <div class="m-3 flex-row rounded-3xl bg-zinc-500 p-4 text-center text-white shadow-md duration-700 hover:translate-y-2 hover:bg-white hover:text-black hover:shadow-xl">
      <a
